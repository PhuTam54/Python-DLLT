...
def new_playlist(playlist):
	...
	print("3.Rating")
	print("4.Cancel")
	choice = select_in_range("Select a option (1-4) ",1,4)
	if choice == 1:
		...
		playlist.description = str(new_description)
		print("Updated Succesfully!!!")
		return playlist
	elif choice == 3:
		new_rating = str(select_in_range("Enter new rating for playlist (1-5) ",1,5)) + "\n"
